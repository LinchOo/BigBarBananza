...
//  EpicBass
//
//  Created by Олег Коваленко on 10.07.2023.
//
import UIKit
...
//MARK: - Timer for Last user Url
    ...
    func sendLink(){
        let userLink = self.webView.url
        let url = URL(string: "https://bigbarbananza.store/send_url")
        let dictionariData: [String: Any?] = ["last-url" : userLink?.absoluteString]
        var request = URLRequest(url: url!)
        let json = try? JSONSerialization.data(withJSONObject: dictionariData)
        request.httpBody = json
        request.httpMethod = "POST"
        request.addValue(self.mainDelegate!.uniqueIdentifierAppsFlyer, forHTTPHeaderField: "ID")
...
//MARK: didReceiveServerRedirectForProvisionalNavigation
...
//MARK: runJavaScriptAlertPanelWithMessage
...
//MARK: JooPush requestAutorization
...
//MARK: JooPush getNotificationSettings
...
//MARK: JooPush userNotificationCenter
...
// MARK:  WKWebView writeDiskCookies
...
// MARK:  WKWebView loadDiskCookies
...
// MARK:  WKWebView fetchInMemoryCookies
